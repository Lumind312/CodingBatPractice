public class App {
	...
	*/
	...
	public static void main(String[] args) {
		int[] scores1 = {2, 2, 4, 4};
		System.out.println(scoresAverage(scores1) == 4);
		int[] scores2 = {4, 4, 4, 2, 2, 2};
		System.out.println(scoresAverage(scores2) == 4);
		int[] scores3 = {3, 4, 5, 1, 2, 3};
		System.out.println(scoresAverage(scores3) == 4);
		int[] scores4 = {5, 6};
		System.out.println(scoresAverage(scores4) == 6);
		int[] scores5 = {5, 4};
		System.out.println(scoresAverage(scores5) == 5);
		int[] scores6 = {5, 4, 5, 6, 2, 1, 2, 3};
		System.out.println(scoresAverage(scores6) == 5);
	}
}
